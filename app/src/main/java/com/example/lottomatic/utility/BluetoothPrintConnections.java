...
import com.example.lottomatic.connection.bluetooth.BluetoothConnections;
import com.example.lottomatic.exceptions.EscPosConnectionException;

public class BluetoothPrintConnections extends BluetoothConnections {
    ...
    public static BluetoothConnection selectFirstPaired() {
        BluetoothPrintConnections printers = new BluetoothPrintConnections();
