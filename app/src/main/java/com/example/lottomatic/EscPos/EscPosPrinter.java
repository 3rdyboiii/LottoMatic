package com.example.lottomatic.EscPos;
...
import com.example.lottomatic.textparser.IPrinterTextParserElement;
import com.example.lottomatic.textparser.PrinterTextParser;
import com.example.lottomatic.textparser.PrinterTextParserColumn;
import com.example.lottomatic.textparser.PrinterTextParserLine;
import com.example.lottomatic.textparser.PrinterTextParserString;
...
public class EscPosPrinter extends EscPosPrinterSize {
    ...
    public EscPosPrinter printFormattedTextAndCut(String text, int dotsFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        ...
        this.printer.cutPaper(); // Send the cut command
